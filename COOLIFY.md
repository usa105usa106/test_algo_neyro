# Coolify deploy — ChatGPT Scan Bot 30d 47_full
...
5. Press `/ping`; expected version: `47_full`.
...
## 47_full TP compact format note
...
## 47_full Intraday 30d no-cache update
...
## 47_full Intraday progress/message order update
...
## 47_full Intraday robustness audit
...
### 47_full Stress Test spot/completeness fix
...
## 47_full Intraday instruction cleanup
- Version is now `47_full`.
...
## 47_full Intraday task-only fix
- Version is now `47_full`.
