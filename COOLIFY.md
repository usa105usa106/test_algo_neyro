# Coolify deploy — ChatGPT Scan Bot 30d v36_full
...
5. Press `/ping`; expected version: `v36_full`.
...
## v36_full TP compact format note
...
## v36_full Intraday 30d no-cache update
...
## v36_full Intraday progress/message order update
...
## v36_full Intraday robustness audit
