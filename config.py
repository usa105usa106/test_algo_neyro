...
APP_VERSION = "65_full_GMAIL_COOLIFY_PORT80_ROUTE_FIX"
...
def _resolve_gmail_public_base_url() -> str:
    ...
    v65 listens on container port 80 and prefers Coolify's explicit
    port-specific ``SERVICE_URL_<ID>_80`` route. The external URL still uses
