...
APP_VERSION = "69_full_GMAIL_LOG_MAIL_DIAGNOSTICS"
...
def _resolve_gmail_public_base_url() -> str:
    ...
    v69 receives the FQDN generated for the isolated gateway service. The
    Telegram bot listens privately on 8080; Coolify routes public HTTPS only
    to the gateway on port 80.
    """
    for key in (
        "GMAIL_PUBLIC_BASE_URL",
        "GMAIL_REDIRECT_URI",  # backward compatibility; endpoint is stripped
        # v69 isolated gateway identifier. The bot receives only the FQDN,
        # while SERVICE_URL_GMAILAUTH_80 is declared on the gateway service.
